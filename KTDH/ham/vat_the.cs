...
namespace KTDH.ham
{
    ...
    class Cay
    {
        ...
        private int chieuCao_nuoc;
        private int chieuRong_nuoc;
        private int chieuCao_ao;
        private int chieuRong_ao;
        private int bk_tao;
        public Point[] LsPoint
        {
            get => lsPoint;
        ...
        public int ChieuCao_nuoc { get => chieuCao_nuoc; set => chieuCao_nuoc = value; }
        public int ChieuRong_nuoc { get => chieuRong_nuoc; set => chieuRong_nuoc = value; }
        public int ChieuCao_ao { get => chieuCao_ao; set => chieuCao_ao = value; }
        public int ChieuRong_ao { get => chieuRong_ao; set => chieuRong_ao = value; }

        public Cay()
        {
            //than cay
            LsPoint[0] = new Point(1200, 350);
            LsPoint[1] = new Point(1240, 350);
            ...
            //song bat dau tu orange
            LsPoint[8] = new Point(1260, 450);
            ChieuCao_la = 20;
            ChieuRong_la = 16;
            ChieuCao_nuoc = 0;
            ChieuRong_nuoc = 0;
        ...
        public void Draw(Graphics g)
        {
            ToMau(g);
            //ve ao
            Hinh_Elip ao = new Hinh_Elip(this.lsPoint[8], chieuRong_ao, chieuCao_ao);
            ao.Color = Color.LightCyan;
            ao.Draw(g);
        ...
        public void drawNuoc1(Graphics g)
        {
            Hinh_Elip nuoc = new Hinh_Elip(this.lsPoint[8], ChieuCao_nuoc, ChieuRong_nuoc);
            nuoc.Color = Color.Cyan;
            nuoc.Draw(g);
        }
        public void drawNuoc2(Graphics g)
        {
            Hinh_Elip nuoc = new Hinh_Elip(this.lsPoint[8], ChieuCao_nuoc - 9, ChieuRong_nuoc - 9);
            nuoc.Color = Color.Cyan;
            nuoc.Draw(g);
        }
        public void drawNuoc3(Graphics g)
        {
            Hinh_Elip nuoc = new Hinh_Elip(this.lsPoint[8], ChieuCao_nuoc - 15, ChieuRong_nuoc - 15);
            nuoc.Color = Color.Cyan;
            nuoc.Draw(g);
        }
        public void ToMau(Graphics g)
        {
            ...
            SolidBrush brush4 = new SolidBrush(Color.LightCyan);

            //to mau ao nuoc
            g.FillEllipse(brush4, this.lsPoint[8].X - chieuRong_ao * 10 / 2, this.lsPoint[8].Y - chieuCao_ao * 10 / 2, chieuRong_ao * 10, chieuCao_ao * 10);
