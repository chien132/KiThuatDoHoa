...
namespace KTDH._3D
{
    class Cube
    {
        ...
        public Cube(int x, int y, int z, int chieuDai, int chieuCao, int chieuRong)
        {
        ...
        public void Draw(Graphics g)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                char c = (char)(65 + i);
                g.DrawString(c.ToString(), new Font("Verdana", 14), Brushes.Aqua, point);
            }
        }
        /// <summary>
        ...
        public void DrawLine(Graphics g, int A, int B, int n = 1)
        {
            ...
            {
                point = ToaDo.NguoiDungMayTinh_3D(this.Dinh[i, 0], this.Dinh[i, 1], this.Dinh[i, 2]);
                ToaDo.HienThi(point, g, Color.Aqua);
                char c = (char)(65 + i);
                g.DrawString(c.ToString(), new Font("Verdana", 14), Brushes.Aqua, point);
            }
        }
